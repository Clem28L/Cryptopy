...
class App(tk.Tk):
    ...
    def frame_principale(self):
        ...
        self.textePrincipale = tk.Label(self.frameprincipale, text="hey")
        self.textePrincipale.pack()
        self.frameprincipale.pack(padx=100, pady=200)
    ...
    def frame_menu_crypto(self):
        ...
        self.info = Button(self.frame1, text="information",padx=20, pady=70, bg="#878993", relief=FLAT, activebackground="#878993", borderwidth=0, highlightthickness=0, font=fontmenu, command=lambda x=1: fen.destroy() & os.system("python btc.py") )
        self.btc_button = Button(self.frame1, text="Bitcoin (BTC)",padx=10, pady=70, bg="#878993", relief=FLAT,activebackground="#878993" , borderwidth=0, highlightthickness=0, font=fontmenu, )
        self.eth_button = Button(self.frame1, text="Ethereum (ETH)",padx=10, pady=70, bg="#878993", relief=FLAT, activebackground="#878993", borderwidth=0, highlightthickness=0, font=fontmenu)
        self.lite_button = Button(self.frame1, text="Litecoin (LTC)",padx=10, pady=70, bg="#878993", relief=FLAT, activebackground="#878993", borderwidth=0, highlightthickness=0, font=fontmenu)
